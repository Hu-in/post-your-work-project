...
def get_filters():
    ...
    """
    # Collect and validate user input for city/month/day
...
def load_data(city, month, day):
    ...
    Args:
        ...
        (str) day - name of the day of week to filter by, or "all" to apply no day filter
    Returns:
        bikeshare_df - Pandas DataFrame containing city data filtered by month and day
    """
...
def main():
    while True:
        ...
        bikeshare_bikeshare_df = load_data(city, month, day)
